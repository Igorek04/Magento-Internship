...
class Config
{
    ...
    public static $moduleVersion        = "4.5.4";
    public static $minStripePHPVersion  = "17.6.0";
    private static $moduleUrl           = "https://stripe.com/docs/plugins/magento";
    ...
    {
        if ($this->isPaymentLineItemsEnabled())
        {
            $apiVersion = $this->scopeConfig->getValue('stripe_settings/api/version_preview', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, 0);
        }
        else
        {
    ...
    public function getSetupFutureUsage($quote)
    {
        ...
        $hasSubscriptions = $this->quoteHelper->hasSubscriptions($quote);
    ...
    {
        if ($this->areaCodeHelper->isAdmin() || $this->quoteHelper->isMultiShipping())
        {
            return false;
        }
    ...
    {
        return !!$this->scopeConfig->getValue('payment/stripe_payments_advanced_configuration/send_missing_order_emails', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
